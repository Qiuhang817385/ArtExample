...
exports.App = (props) => (React.createElement(React.Fragment, null,
    React.createElement(Hello_1.Hello, { compiler: '编译', framework: '框架' }),
    React.createElement(Hello_1.HelloClass, { compiler: '类编译', framework: '类框架' }),
    React.createElement(Hello_1.HelloFun, { compiler: '函数编译', framework: '函数框架' })));
...
exports.Hello = (props) => (React.createElement("h1", null,
    ...
    " and ",
    props.framework));
exports.HelloFun = (props) => (React.createElement("h1", null,
    "hello from",
    props.compiler,
    " and ",
    props.framework));
